...
CREATE TABLE `listimg` (
  ...
  PRIMARY KEY (`IDimg`),
  KEY `index` (`IDimg`) USING BTREE,
  CONSTRAINT `fk_listmg_product` FOREIGN KEY (`IDimg`) REFERENCES `products` (`ProID`) ON DELETE CASCADE ON UPDATE NO ACTION
...
CREATE TABLE `orderdetails` (
  ...
  KEY `FK_ProID` (`ProID`),
  CONSTRAINT `fk_Orderdetail_Product` FOREIGN KEY (`ProID`) REFERENCES `products` (`ProID`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `fk_Order_Orderdetail` FOREIGN KEY (`OrderID`) REFERENCES `orders` (`OrderID`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- ----------------------------
-- Records of orderdetails
-- ----------------------------
INSERT INTO `orderdetails` VALUES ('1', '2', '4', '2000000', '8000000', '2017-11-15');
INSERT INTO `orderdetails` VALUES ('1', '5', '5', '1200000', '6000000', '2017-11-15');
...
INSERT INTO `orderdetails` VALUES ('29', '3', '23', '1000000', '23000000', '2018-04-04');
INSERT INTO `orderdetails` VALUES ('30', '3', '23', '1000000', '23000000', '2018-04-04');
...
CREATE TABLE `orders` (
  ...
  PRIMARY KEY (`OrderID`),
  KEY `abc` (`Username`) USING BTREE,
  CONSTRAINT `fk_order_user` FOREIGN KEY (`Username`) REFERENCES `users` (`f_Username`) ON DELETE CASCADE ON UPDATE NO ACTION
...
INSERT INTO `orders` VALUES ('9', '2018-03-03 00:00:00', 'quangadmin', '0', '0');
INSERT INTO `orders` VALUES ('10', '2018-03-03 00:00:00', 'quangadmin', '0', '2');
...
INSERT INTO `orders` VALUES ('29', '2018-04-04 00:00:00', 'quangadmin', '0', '0');
INSERT INTO `orders` VALUES ('30', '2018-04-04 00:00:00', 'quangadmin', '0', '1');
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('1', 'quangadmin', 'c183d2026bdc71b68ef230b9ad8b4bc0', 'Phùng Văn Quang', 'quang@gmail.com', '1', '2018-04-04', 'Nguyễn Văn Cừ 123', '01222764497');
INSERT INTO `users` VALUES ('2', 'QUANGQUANG', 'e10adc3949ba59abbe56e057f20f883e', 'QuangQuang1997', 'quang@gmail.com', '0', '2017-11-21', '1231321', '123123');
INSERT INTO `users` VALUES ('27', 'Phamngoctuoi', 'e10adc3949ba59abbe56e057f20f883e', 'Phạm Ngọc Tươi', 'phamngoctuoi22041997@gmail.com', '0', '2018-02-11', 'Cộng hòa', '01222764499');
...
INSERT INTO `users` VALUES ('37', 'phungvanquang1997', 'e10adc3949ba59abbe56e057f20f883e', 'phungvanquang1997', 'phungvanquang1997@gmail.com', '1', '2018-04-06', 'phungvanquang1997', '01222764497');
INSERT INTO `users` VALUES ('38', 'quangquangquang', '2b7750ca6c5e773015292b97a8f188d6', 'quangquangquang', 'quangquangquang@gmail.com', '0', '2018-05-02', 'quangquangquang', '123123');
